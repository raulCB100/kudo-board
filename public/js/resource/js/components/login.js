...
/* harmony import */ var _core_Messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core/Messages */ "./resources/js/core/Messages.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "login",
  components: {
    AppNavbar: _components_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      auth: {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                return axios.post("/api/login", _this.auth).then(function (_ref) {
                  ...
                  _core_Messages__WEBPACK_IMPORTED_MODULE_2__["default"].showErrorMessage(data.message);
                })["finally"](function () {
...
var Messages = /*#__PURE__*/function () {
  ...
  _createClass(Messages, null, [{
    ...
    key: "showInfoMessage",
    value: function showInfoMessage(message) {
      app.$buefy.toast.open({
        message: message,
        type: 'is-info',
        duration: 5000
...
var render = function () {
  ...
  return _c("div", [
    _c(
      "section",
      { staticClass: "hero has-background-white-bis is-fullheight" },
      [
        _c("div", { staticClass: "hero-body" }, [
          _c("div", { staticClass: "container has-text-centered" }, [
            _c("div", { staticClass: "column is-4 is-offset-4" }, [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "box top-margin-5" }, [
                _vm._m(0),
                _vm._v(" "),
                _c("form", [
                  _c("div", { staticClass: "field" }, [
                    _c(
                      ...
                      [
                        _c(
                          "b-field",
                          { attrs: { label: "Email", type: "is-info" } },
                          [
                            _c("b-input", {
                              attrs: {
                                type: "email",
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                " +
                          _vm._s(
                            _vm.processing ? "Espera un momento" : "Entrar"
                          ) +
                          "\n              "
                      ),
                    ]
              ...
              _c("p", { staticClass: "has-text-grey" }, [
                _c(
                  "label",
                  [
                    _vm._v("¿Aún no tienes tu cuenta?\n              "),
...
var render = function () {
  ...
  return _c(
    "nav",
    {
      staticClass: "navbar has-background-white-bis",
